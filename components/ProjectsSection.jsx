        ...
        {projects.map((project, index) => (
          <Link key={index} href={`/projects/${project.slug}`}>
            <motion.div
              ...
              className="group cursor-pointer rounded-2xl overflow-hidden shadow-sm border border-primary/20 hover:shadow-2xl transition duration-500 bg-white"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <div className="inline-flex items-center gap-2 text-primary font-semibold group-hover:gap-3 transition-all duration-300">
                  Learn More
                  <span className="transform group-hover:translate-x-1 transition-all duration-500">
                    <FaChevronCircleRight className="text-sm" />
                  </span>
                </div>
              </div>
            </motion.div>
