...
export default function LifestyleExperience() {
  return (
    <section className="relative overflow-hidden bg-[#f8f3ec] text-[#241818]">
      <div className="absolute inset-y-0 left-0 hidden w-[34%] bg-[#380a0a] lg:block" />

      <div className="custom-container relative z-10 mx-auto py-16 md:py-24 lg:py-32">
        <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div className="relative min-h-[560px] overflow-hidden border border-white/15 bg-[#380a0a] shadow-2xl shadow-black/25">
            <Image
            ...
            <div className="absolute bottom-0 left-0 max-w-md border-t border-r border-white/18 bg-[#380a0a]/82 p-7 backdrop-blur-md md:p-9">
          ...
          <div className="relative">
            <div className="mb-8 max-w-2xl">
              ...
              <h3 className="text-3xl font-semibold leading-tight text-[#380a0a] md:text-5xl">
            ...
            <div className="grid border border-[#380a0a]/16 bg-white/70 backdrop-blur-sm sm:grid-cols-2">
              {lifestyleHighlights.map((item, index) => (
                <div
                  key={item}
                  className="group relative min-h-[138px] border-b border-[#380a0a]/12 p-6 transition duration-300 hover:bg-[#380a0a] sm:border-r md:p-7"
                >
                  <div className="mb-6 flex items-center justify-between gap-5">
                    <span className="text-xs font-semibold uppercase tracking-[0.22em] text-[#380a0a]/55 transition duration-300 group-hover:text-white/55">
                      {String(index + 1).padStart(2, "0")}
                    </span>

                    <span className="h-px w-16 origin-left scale-x-[0.35] bg-[#380a0a] transition-transform duration-700 ease-out group-hover:scale-x-100 group-hover:bg-white" />
                  </div>
            ...
            <div className="mt-8 flex flex-col gap-4 border-l border-[#380a0a]/30 pl-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button className="group inline-flex items-center justify-center gap-4 bg-[#380a0a] px-7 py-4 text-sm font-bold uppercase tracking-[0.14em] text-white shadow-xl shadow-[#380a0a]/20 transition duration-300 hover:bg-[#241818]">
                Get In Touch
