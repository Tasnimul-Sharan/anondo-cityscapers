...
export function ContentSections({
  ...
  return (
    <section className="overflow-hidden bg-[#f8f3ec] text-[#241818]">
      <div className="relative border-b border-[#380a0a]/15 py-16 md:py-24 lg:py-32">
        <div className="absolute right-0 top-0 hidden h-full w-[30%] bg-[#380a0a] lg:block" />

        <div className="relative z-10 mx-auto max-w-[1200px] px-5">
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
            <div>
              <p className="mb-5 inline-flex items-center gap-3 text-xs font-extrabold uppercase tracking-[0.26em] text-[#380a0a]">
                <span className="h-px w-10 bg-current" />
                The Estate Story
              </p>

              <h1 className="max-w-4xl text-4xl font-semibold leading-[0.98] text-[#380a0a] md:text-6xl lg:text-7xl">
            ...
            <div className="border border-white/15 bg-[#380a0a] p-7 text-white shadow-2xl shadow-[#380a0a]/20 lg:backdrop-blur-md">
          ...
          <div className="mt-14 grid border border-[#380a0a]/15 bg-white shadow-2xl shadow-[#380a0a]/10 md:grid-cols-3">
            {[
              ["807", "Bigha Estate"],
              ["60 ft", "Grand Avenue"],
              ["Villa", "Only Township"],
              ...
              <div
                key={label}
                className="border-b border-[#380a0a]/15 p-7 md:border-b-0 md:border-r md:last:border-r-0"
              >
                <p className="text-4xl font-bold leading-none text-[#380a0a]">
                  {value}
                </p>
            ...
            {[intro, identity].map((section, index) => (
              <article
                ...
                className={`group border p-7 shadow-2xl md:p-10 ${
                  index === 0
                    ? "border-[#380a0a]/15 bg-white text-[#241818] shadow-[#380a0a]/10"
                    : "border-white/15 bg-[#380a0a] text-white shadow-[#380a0a]/20"
                }`}
              >
                ...
                <h2
                  className={`text-3xl font-semibold leading-tight md:text-5xl ${
                    index === 0 ? "text-[#380a0a]" : "text-white"
                  }`}
                >
                  {section.title}
                </h2>
        ...
        <div className="bg-white py-16 md:py-24 lg:py-32">
          <div className="mx-auto grid max-w-[1200px] gap-12 px-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div className="relative">
              <div className="absolute -left-5 -top-5 hidden h-full w-full border border-[#380a0a]/15 lg:block" />
              <div className="relative min-h-[560px] overflow-hidden bg-[#380a0a] shadow-2xl shadow-[#380a0a]/20">
                <Image
                ...
                />
                <div className="absolute inset-x-0 bottom-0 bg-[#380a0a]/88 p-7 text-white backdrop-blur-md">
            ...
            {/* <article>
              <p className="mb-5 inline-flex items-center gap-3 text-xs font-extrabold uppercase tracking-[0.24em] text-[#380a0a]">
                <span className="h-px w-10 bg-current" />
                Chairman
              </p>

              <h2 className="text-4xl font-semibold leading-tight text-[#380a0a] md:text-6xl">
                Chairman's Foreword
              </h2>

              <div className="mt-8 grid gap-5 border-l border-[#380a0a]/25 pl-6">
              ...
              {chairman.signature && (
                <div className="mt-8 border-t border-[#380a0a]/15 pt-6">
                  <p className="font-extrabold text-[#380a0a]">
                    {chairman.signature}
                  </p>
                </div>
              )}
            ...
            <article>
              ...
              {/* {chairman.signature && (
                <div className="mt-9 border-t border-[#380a0a]/15 pt-7">
                  <div className="relative overflow-hidden border-l-2 border-[#380a0a] bg-[#f8f3ec] px-6 py-5">
                    <p className="text-lg font-extrabold leading-tight text-[#380a0a]">
                      Gazi Md. Mozammel Hoque
                    </p>
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-3 text-sm text-[#6b5d57]">
                      ...
                      <span className="h-px w-8 bg-[#380a0a]/35" />
                      <span>Anondo Rosemont Estate</span>
                    </div>

                    <div className="mt-4 flex items-start gap-3">
                      <span className="mt-1 text-3xl font-serif leading-none text-[#380a0a]/35">
                        “
                      </span>
              ...
              {chairman.signature && (
                <div className="mt-8 border-t border-[#380a0a]/15 pt-6">
                  <div className="border-l border-[#380a0a]/35 pl-4">
                    <p className="font-extrabold text-[#380a0a]">
                      Gazi Md. Mozammel Hoque
                    </p>
      ...
      {founder && (
        <div className="bg-[#380a0a] py-16 text-white md:py-24 lg:py-32">
          ...
          <div className="mx-auto max-w-[1200px] px-5">
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              {philosophyItems.map((item, index) => (
                <article
                  key={item.title}
                  className="group border border-[#380a0a]/15 bg-white p-7 shadow-xl shadow-[#380a0a]/10 transition duration-500 hover:-translate-y-2 hover:bg-[#380a0a] hover:text-white"
                >
                  <p className="mb-7 text-xs font-extrabold uppercase tracking-[0.22em] text-[#380a0a]/45 transition group-hover:text-white/50">
        ...
        <div className="mx-auto max-w-[1200px] px-5">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {estatePrinciples.map((item) => (
              <article
                key={item.title}
                className="group border border-[#380a0a]/15 bg-[#f8f3ec] p-8 shadow-xl shadow-[#380a0a]/10 transition duration-500 hover:-translate-y-2 hover:bg-[#380a0a] hover:text-white"
              >
        ...
        <div className="mx-auto max-w-[1200px] px-5">
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr]">
            <aside className="hidden lg:block">
              <div className="sticky top-28 border-l border-[#380a0a]/20 pl-7">
                <p className="text-xs font-extrabold uppercase tracking-[0.26em] text-[#380a0a]/55">
                  Complete Narrative
                </p>
                <h2 className="mt-5 text-3xl font-semibold leading-tight text-[#380a0a]">
            ...
            <div className="grid gap-7">
              {remainingSections.map((section, index) => (
                <article
                  key={section.title}
                  className="group border border-[#380a0a]/15 bg-white p-7 shadow-xl shadow-[#380a0a]/10 md:p-10"
                >
                  <div className="mb-8 flex items-center justify-between gap-6">
                    <p className="text-sm font-extrabold uppercase tracking-[0.24em] text-[#380a0a]/45">
                      {String(index + 1).padStart(2, "0")}
                    </p>
                    <span className="h-px w-24 origin-left scale-x-[0.35] bg-[#380a0a] transition-transform duration-700 group-hover:scale-x-100" />
                  </div>

                  <h3 className="text-2xl font-semibold leading-tight text-[#380a0a] md:text-4xl">
                    {section.title}
                  </h3>
