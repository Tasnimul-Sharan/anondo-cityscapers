      ...
      {items.map((item, index) => (
        <article
          ...
          className={`group min-h-[210px] border p-7 shadow-xl transition duration-500 hover:-translate-y-1 ${
            dark
              ? "border-white/15 bg-white/10 text-white hover:bg-white hover:text-[#380a0a]"
              : "border-[#380a0a]/15 bg-white/75 text-[#241818] shadow-[#380a0a]/10 hover:bg-[#380a0a] hover:text-white"
          }`}
        >
          <p
            className={`mb-6 text-xs font-extrabold uppercase tracking-[0.2em] ${
              dark
                ? "text-white/55 group-hover:text-[#380a0a]/55"
                : "text-[#380a0a]/55 group-hover:text-white/55"
            }`}
          >
