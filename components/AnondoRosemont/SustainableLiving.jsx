...
//       <div className="absolute left-0 top-0 hidden h-full w-[30%] bg-[#380a0a] lg:block" />
...
//             <h2 className="max-w-2xl text-3xl font-semibold leading-tight text-[#380a0a] md:text-5xl lg:text-white">
...
//             <article
//               key={item.title}
//               className="group relative min-h-[370px] overflow-hidden border border-[#380a0a]/15 bg-white p-7 shadow-xl shadow-[#380a0a]/10 transition duration-500 hover:-translate-y-2 hover:bg-[#380a0a] hover:shadow-2xl hover:shadow-[#380a0a]/20"
//             >
//               <div className="absolute left-0 top-0 h-full w-full origin-left scale-x-0 bg-[#380a0a] transition-transform duration-700 ease-out group-hover:scale-x-100" />

//               <div className="relative z-10 flex h-full flex-col">
//                 <div className="mb-10 flex items-center justify-between">
//                   <span className="text-xs font-extrabold uppercase tracking-[0.22em] text-[#380a0a]/45 transition duration-300 group-hover:text-white/45">
//                     {String(index + 1).padStart(2, "0")}
//                   </span>

//                   <span className="h-px w-14 origin-left scale-x-[0.35] bg-[#380a0a] transition-transform duration-700 ease-out group-hover:scale-x-100 group-hover:bg-white" />
//                 </div>
...
//                 <button className="mt-auto inline-flex items-center gap-4 pt-10 text-sm font-bold uppercase tracking-[0.14em] text-[#380a0a] transition duration-300 group-hover:text-white">
//                   Direction
    ...
    <section className="bg-[#f8f3ec] py-16 text-[#241818] md:py-24 lg:py-32">
      <div className="mx-auto max-w-[1180px] px-5">
        ...
        <div className="grid lg:grid-cols-[0.62fr_1.38fr]">
          <div className="hidden border-r border-[#380a0a]/15 pt-14 lg:block">
            <div className="sticky top-28 pr-10">
              <p className="text-[11px] font-extrabold uppercase tracking-[0.28em] text-[#380a0a]/55">
                Rosemont Living Principles
              </p>
              <p className="mt-5 text-2xl font-semibold leading-snug text-[#380a0a]">
          ...
          <div className="divide-y divide-[#380a0a]/15 lg:pl-10">
            {sustainableItems.map((item, index) => (
              <article
                key={item.title}
              ...
              >
                <div className="flex items-center gap-5">
                  <span className="text-sm font-extrabold uppercase tracking-[0.24em] text-[#380a0a]/45 transition duration-300 group-hover:text-[#380a0a]">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  <span className="h-px w-14 origin-left scale-x-[0.35] bg-[#380a0a] transition-transform duration-700 ease-out group-hover:scale-x-100 md:hidden" />
                </div>

                <div>
                  <h3 className="text-2xl font-semibold leading-tight text-[#241818] transition duration-300 group-hover:text-[#380a0a] md:text-3xl">
                    {item.title}
                  </h3>
                ...
                <button className="group/btn inline-flex w-fit items-center gap-4 text-sm font-bold uppercase tracking-[0.14em] text-[#380a0a]">
                  Direction
...
//   return (
//     <section className="relative overflow-hidden bg-[#f8f3ec] py-16 text-[#241818] md:py-24 lg:py-32">
//       <div className="absolute right-0 top-0 hidden h-full w-[31%] bg-[#380a0a] lg:block" />
...
//               >
//                 <div className="flex items-center gap-5">
//                   <span className="text-sm font-extrabold uppercase tracking-[0.24em] text-[#380a0a]/45 transition duration-300 group-hover:text-[#380a0a] lg:group-hover:text-white">
//                     {String(index + 1).padStart(2, "0")}
//                   </span>
//                   <span className="h-px w-14 origin-left scale-x-[0.35] bg-[#380a0a] transition-transform duration-700 ease-out group-hover:scale-x-100 md:hidden" />
//                 </div>
...
//                 <div>
//                   <h3 className="text-2xl font-semibold leading-tight text-[#241818] transition duration-300 group-hover:text-[#380a0a] md:text-3xl lg:group-hover:text-white">
//                     {item.title}
//                   </h3>
...
//                 <button className="group/btn inline-flex w-fit items-center gap-4 text-sm font-bold uppercase tracking-[0.14em] text-[#380a0a] lg:text-white">
//                   Direction
//                   <span className="h-px w-12 origin-left scale-x-[0.35] bg-current transition-transform duration-700 ease-out group-hover:scale-x-100 group-hover/btn:scale-x-100" />
//                 </button>
//               </article>
