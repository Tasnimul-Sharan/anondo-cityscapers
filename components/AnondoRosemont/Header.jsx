...
export function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/15 bg-[#380a0a]/95 text-white backdrop-blur-xl">
      <div className="mx-auto flex min-h-[76px] max-w-[1180px] items-center justify-between gap-6 px-5">
        ...
        <Link
          href="/contact"
          className="group hidden items-center gap-3 border border-white/25 bg-white/10 px-5 py-3 text-xs font-extrabold uppercase tracking-[0.14em] transition hover:bg-white hover:text-[#380a0a] sm:inline-flex"
        >
          Enquire
